...
__project__:
原始Transformer对比实验
实验3: 缺失测井曲线预测实验：大庆油田井A数据集中  预测DEN
__time__:  2024/4/4
...
if train_model:
    ...
    for epoch in tqdm(range(epochs)):
        ...
        if val_epoch_loss < best_test_loss:
            ...
            torch.save(best_model.state_dict(), '../pth/best_Transformer_trainModel_DEN_缺失.pth')
...
file_name = '../../result/wlp_transformer/daqingyoutian_result缺失_DEN_原始T.xlsx'

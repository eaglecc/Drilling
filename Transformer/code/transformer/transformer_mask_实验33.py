...
print("MAPE:", mape)
# 创建一个txt文件并将结果写入其中
resultpath = ('../../result/transformer/experiment33_batch{}_epoch_{}.txt').format(batch_size, epochs)
...
print("预测结果已写入experiment33_epoch_{}.txt文件")
...
file_name = '../../result/transformer_daqingyoutian_result_DEN.xlsx'

...
file_name = '../../result/daqingyoutian_GRU_SP_result.xlsx'
# 如果文件不存在，创建一个新 Excel 文件并存储数据
df = pd.DataFrame({'gru_SP_predicted': predicted_original_data.flatten()})  # 创建一个新 DataFrame
df['gru_SP_true'] = test_target_original_data

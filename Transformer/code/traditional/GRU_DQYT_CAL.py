...
file_name = '../../result/daqingyoutian_GRU_CAL_result.xlsx'
# 如果文件不存在，创建一个新 Excel 文件并存储数据
df = pd.DataFrame({'gru_CAL_predicted': predicted_original_data.flatten()})  # 创建一个新 DataFrame
df['gru_CAL_true'] = test_target_original_data

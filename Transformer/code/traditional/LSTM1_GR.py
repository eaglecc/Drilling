...
data_x = data[['DENSITY', 'PEF', 'EPOR0', 'NPHI']]
data_y = data['GR']
# data_y = data['DENSITY']
# data_y = data['EPOR0']

# 对岩性标签进行处理
# data_LITH1 = data[data['LITH'] == 1]
# data_LITH2 = data[data['LITH'] == 2]
# data_LITH3 = data[data['LITH'] == 3]
# data_LITH1_GR_average = data_LITH1['GR'].mean()
# data_LITH2_GR_average = data_LITH2['GR'].mean()
# data_LITH3_GR_average = data_LITH3['GR'].mean()
# data['LITH'] = data['LITH'].replace(1, data_LITH1_GR_average)
# data['LITH'] = data['LITH'].replace(2, data_LITH2_GR_average)
# data['LITH'] = data['LITH'].replace(3, data_LITH3_GR_average)
# data_x['LITH'] = data['LITH']
...
#     df['lstm_GR_predicted1'] = predicted
#     df['lstm_GR_true1'] = test_target

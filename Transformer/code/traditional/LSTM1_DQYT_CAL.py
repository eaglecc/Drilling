...
__project__: LSTM进行大庆油田上 测井曲线预测实验
__time__:  2023/10/27
...
file_name = '../../result/daqingyoutian_lstm_CAL_result.xlsx'
# 如果文件不存在，创建一个新 Excel 文件并存储数据
df = pd.DataFrame({'lstm_CAL_predicted': predicted_original_data.flatten()})  # 创建一个新 DataFrame
df['lstm_CAL_true'] = test_target_original_data
